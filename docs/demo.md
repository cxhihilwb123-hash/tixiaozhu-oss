...
The student app starts from a learning dashboard with points, progress, practice entry points, capture/manual correction, wrong-question review, and question-store navigation.

![Student learning dashboard](assets/screenshots/student-home.png)

## 2. Question Store

The question store organizes primary-school Chinese, math, and English into textbook-sync, special-training, and paper/diagnostic packs. The current baseline contains `252` packs, `6912` questions, and `108` knowledge points.
